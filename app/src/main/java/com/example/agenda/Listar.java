...
public class Listar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ConexionSQLiteHelper conexion = new ConexionSQLiteHelper(Listar.this, Utilerias.NOMBRE_BD, null, 1);
        SQLiteDatabase bd = conexion.getReadableDatabase();
        String[] campos = {Utilerias.CAMPO_NOMBRE, Utilerias.CAMPO_TELEFONO, Utilerias.CAMPO_ID};
        Cursor cursor = bd.query(Utilerias.TABLA_PERSONA, campos,
...
// Fin del ciclo. Cerramos cursor y regresamos la lista de mascotas :) cursor.close();
